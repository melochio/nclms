                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    @if($info->del_status == 1)
                                                    <button title="Disable" class="btn btn-danger btn-sm br-0" onclick="disableuser('{{$info ->id }}','/usermanagement/disableuser')"><i class="fa fa-toggle-off"></i> Disable</button>
                                                    @else
                                                    <button title="Enable" class="btn btn-success btn-sm br-0" onclick="enableuser('{{$info ->id }}','/usermanagement/enableuser')"><i class="fa fa-toggle-on"></i> Enable</button>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3 logindetails">
                                        <span class="bg-success bg-success btn-block text-white">Student Details</span>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            <label><span class="text-danger"><span class="text-danger">*</span></span> Student ID # </label>
                                            <input  type="text" name="account_id" id="account_id" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            <label><span class="text-danger">*</span> Upload Student ID</label>
...
<script type="text/javascript">
    ...
    function newUser(){
        ...
        $('#addRowModal').find('.modal-title').text('Student Details');
        $('#myForm').attr('action','/usermanagement/students');
        $("#first_name").val('');
        $("#middle_name").val('');
        $("#last_name").val('');
    ...
    function disableuser(id, url){
        swal({
          title: "Disable Student Account?",
          text: "Disabling an account will prevent this user from accessing it.",
          icon: "warning",
          buttons: [
            'No',
            'Yes'
    ...
    function enableuser(id, url){
        swal({
          title: "Enable Student Account?",
          text: "Enabling an account will allow this user from accessing it.",
          icon: "warning",
          buttons: [
            'No',
            'Yes'
          ...
          if (isConfirm) {
            ...
            swal({
              ...
              text: 'Account has been successfully enabled!',
              icon: 'success'
            }).then(function() {
                //RELOAD THE PAGE TO SHOW CHANGES AFTER DELETE
                location.reload();
